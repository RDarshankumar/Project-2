...
//       <div className="flex flex-col sm:flex-row gap-4 bg-white p-4 rounded-lg shadow-md transition-all duration-300 hover:shadow-xl">
//         {/* Left Divider */}
        ...
        <div className="flex flex-col justify-between w-full">
          ...
          <div className="flex flex-col sm:flex-row justify-start items-center sm:items-start">
            ...
            <img
              ...
              src={image}
              alt={name}
              className="object-contain w-[150px] h-[150px] sm:w-[82px] sm:h-[82px] rounded-lg transition-all duration-300 hover:scale-105"
            />
