      ...
      <div className="container mx-auto px-4 lg:px-8 py-4">
        <div className="flex flex-wrap justify-between items-center">
          ...
          <div className="flex flex-wrap gap-6 items-center">
            ...
            {/* All Category - Only visible on large screens */}
            ...
            <div className="flex flex-wrap gap-6 hidden lg:flex">
              <a href="#" className="text-sm text-gray-800 hover:text-blue-500">
                Hot Offers
              </a>
              <a href="#" className="text-sm text-gray-800 hover:text-blue-500">
            ...
            {/* Help - Only visible on large screens */}
            <div className="flex items-center gap-2 hidden lg:flex">
              <a href="#" className="text-sm text-gray-800 hover:text-blue-500">
                Help
              </a>
        ...
        {isMenuOpen && (
          <div className="lg:hidden mt-4">
            <div className="flex flex-col gap-4">
              {/* Mobile Options - These are the same options shown on large screens */}
              <div
                className="text-sm text-gray-800 hover:text-blue-500 cursor-pointer"
                onClick={handle}
              >
                All Categories
              </div>
