        ...
        <div className="flex flex-col justify-between w-full">
          ...
          <div className="flex flex-col items-center sm:items-start justify-start">
            ...
            <img
              ...
              src={image}
              alt={name}
              className="object-contain w-[150px] h-[150px] sm:w-[82px] sm:h-[82px] rounded-lg transition-all duration-300 hover:scale-105 mt-4 sm:mt-0"
            />
            
            {/* Name */}
            <h3 className="text-base font-semibold text-zinc-900 mt-4">{name}</h3>
